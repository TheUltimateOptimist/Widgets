...
- ## What it does:
  It applies a transformation to its child before painting it.

- ## View Docs:
  [Transform](https://api.flutter.dev/flutter/widgets/Transform-class.html)
  
- ## Example Code:
  [View on Github](https://github.com/TheUltimateOptimist/Widgets/blob/master/example_writer/lib/transform_example.dart)
